...
const WebOrders = (props) => {
  ...
  const handleAddressSearch = (event) => {
    ...
    setAddressSearchValue(searchValue);
  ...
  const returnValue = () => {
    let data = totalData.discountedAmount;
    console.log(data,'data');
   if(data){
  return   totalData.discountedAmount % 1 !== 0 ? parseFloat(totalData.discountedAmount).toFixed(2) : totalData.discountedAmount
   }   else return 0
  }
            ...
            <div className="form__input">
              <Input
                ...
                inputProps={{
                  ...
                  disabled: true,
                  type: "text",
                  value: totalData && totalData.subTotal,
                }}
                label="Subtotal"
                isFloatedLabel={false}
              />
            ...
            <div className="form__input">
              <Input
                ...
                inputProps={{
                  disabled: true,
                  type: "number",
                  value: totalData && totalData.paidAmount,
            ...
            <div className="form__input">
              <Input
                ...
                inputProps={{
                  disabled: true,
                  type: "text",
                  value: totalData && totalData.totalTax ,
                }}
                label="Tax"
                isFloatedLabel={false}
              />
            ...
            <div className="form__input">
              <Input
                ...
                inputProps={{
                  disabled: true,
                  type: "text",
                  value: totalData && totalData.totalAmount,
                }}
                label="Total"
                isFloatedLabel={false}
              />
