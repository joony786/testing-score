...
import "../../../stock_control/style.scss";
...
function ViewStockRequestSuperAdmin(props) {
  ...
  const getStockRequestById = async (requestId, pageLimit = 10, pageNumber = 1, is_super = 1) => {
    document.getElementById("app-loader-container").style.display = "block";
    const getStockRequestResponse = await SuperAdminApiUtil.getStockRequestSuperAdminById(requestId, pageLimit, pageNumber, is_super);
    if (getStockRequestResponse.hasError) {
      ...
      if (mounted) {
        ...
        if(getStockRequestResponse.transfer.status === "waiting_for_admin_approval"){
            getStockRequestResponse.transfer.status = Constants.STOCK_CONTROL.OPEN;
        }
...
export default ViewStockRequestSuperAdmin;
